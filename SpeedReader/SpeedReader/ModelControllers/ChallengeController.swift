...
class ChallengeController {
    ...
    init() {
        ...
        let speed290 = Challenge(title: "Challenge #3", story: "The older of the two terms is “reading comprehension skills.” It was used occasionally throughout the Twentieth Century, but really took off in a big way in the 1950s. Professional development texts and basal readers were replete with the term and its use burgeoned for about 30 years before slackening a bit.")
